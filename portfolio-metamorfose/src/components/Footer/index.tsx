...
export const Footer = () => {
  return (
    <footer className="w-full bg-transparent">
      <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between gap-4 text-white font-[family-name:var(--font-bellota)] text-[0.8rem] lg:text-[0.8rem]">

        {/* LEFT / Mobile top (copyright) -> Desktop left */}
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-1">
          <p className="leading-none">© 2025 Metamorfose-ph. Todos los derechos reservados.</p>
          {/* Optional small legal / nit */}
          <p className="text-[0.7rem] text-white/70 mt-1 md:mt-0">Hecho con ♥ y fotografía</p>
        </div>
        ...
        {/* CENTER - crédito (se mantiene centrado en desktop) */}
