...
export const AboutComponent = () => {
  ...
  return (
    <motion.section>
      <div id="conoceme" className="h-[100vh] flex justify-between items-center mt-1 relative" ref={ref}>
        <div className="flex flex-col w-full justify-between items-center h-[100vh] ">
          <h1 className={`font-[family-name:var(--font-bellota)] mx-4 text-3xl md:text-6xl lg:text-8xl flex justify-center items-center flex-col text-center z-10 ${animar ? `fade-bottom` : ""}`}>
          ...
          <section className={`${animar ? `fade-top` : ""} z-[1] h-[15rem] flex items-center w-full justify-evenly overflow-hidden transition-all duration-300 ease-in-out`}>
            <h3 className="font-[family-name:var(--font-bellota)] hover:cursor-pointer  hover:blur-xs transition-all duration-300">ARTE</h3>
            <h3 className="font-[family-name:var(--font-bellota)] hover:cursor-pointer  hover:blur-xs transition-all duration-300">FOTOGRAFIA</h3>
            <h3 className="font-[family-name:var(--font-bellota)] hover:cursor-pointer  hover:blur-xs transition-all duration-300">NATURALEZA</h3>
          </section>
        </div>

        {/* Mobile: imagen en el fondo */}
        <div className="md:hidden pointer-events-none">
          <div className="absolute inset-y-0 right-0 w-1/2 sm:w-2/5 z-0 overflow-hidden">
            <Image
        ...
        {/* imagen en vista desktop*/}
        <div className="hidden md:flex z-[-1] mask-fade w-[40rem] h-[40rem] items-center overflow-hidden mr-70">
          <Image
            src="/about-image.jpeg"
            alt="metamorfose-fondo"
            width={2500}
            height={2500}
            className={`hidden sm:block object-cover w-full h-full z-[-1] mask-fade border-2 border-white ${animar ? `fade-top` : ""}`}
          />
        </div>
      </div>
    </motion.section>
