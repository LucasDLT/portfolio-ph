...
export function HomeComponent() {
  ...
  useEffect(() => {
    if (estaEnVista) {
      ...
      setAnimar(false); // opcional: si quieres que se reinicie cuando sale
    }
  }, [estaEnVista]);  return (
    <motion.section
    ref={ref}
    ...
    <div id="home" className="relative z-0 overflow-x-hidden h-[100vh]">
      ...
      <div className={`flex justify-center items-center sm:justify-start sm:ml-16  ${ animar ? "masked-reveal" : ""}`}>
