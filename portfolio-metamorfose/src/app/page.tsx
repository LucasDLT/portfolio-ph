...
export default function Home() {
  ...
  return (
    <>
      ...
      <HomeComponent />
      <p id="portfolio" className="text-2xl">Aqui se mostraran las fotos</p>
...
export const Navbar = () => {
  ...
  sm:translate-y-0`}
      >
        <a className="text-white hover:text-gray-400 duration-300" href="#home">
          inicio
        </a>
        <a
